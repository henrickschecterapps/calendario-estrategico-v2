...
import { MapPin, Clock, Users, ChevronRight, Star, Briefcase, Tag, CalendarDays, User } from "lucide-react";
  ...
  return (
    ...
    >
      <div className="flex items-stretch">
        ...
        {/* Right: Arrow */}
        <div className="hidden md:flex items-center justify-center px-4 border-l border-border group-hover:border-accent/20 transition-colors">
          <div className="w-8 h-8 rounded-full bg-bg flex items-center justify-center group-hover:bg-accent group-hover:text-white transition-all duration-200">
